...
manufacturer1 = Manufacturer.new({"name" => "Scottish Dairy", "phone" => "07554493391"})
manufacturer2 = Manufacturer.new({"name" => "Pillars of Hercules", "phone" => "01337 857749"})
manufacturer3 = Manufacturer.new({"name" => "Grow Wild Organics", "phone" => "07567871001"})
manufacturer4 = Manufacturer.new({"name" => "Tapa Organic Bakery", "phone" => "0141 554 9981"})
manufacturer5 = Manufacturer.new({"name" => "Chop Shop", "phone" => "555-44-33"})
manufacturer6 = Manufacturer.new({"name" => "Shankill Butchers", "phone" => "-"})
manufacturer7 = Manufacturer.new({"name" => "Lettuce Do Our Best", "phone" => "07333066107"})
manufacturer8 = Manufacturer.new({"name" => "Heart Beets", "phone" => "666-666-666"})
manufacturer1.save()
manufacturer2.save()
manufacturer3.save()
manufacturer4.save()
